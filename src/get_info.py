...
class GetInfo:
    ...
    def scrape(self):
        ...
        # メルカリ公式サイトを開く
        self.driver.get("https://jp.mercari.com/search?keyword=" + search_word1 + "%20" + search_word2 + "%20" + search_word3 + "&" + sort_order + "&" + status)

        ### 出品商品情報取得 ###
        self.driver.implicitly_wait(SLEEP_TIME)
        products = self.driver.find_element(By.XPATH, '//*[@id="item-grid"]/ul')
